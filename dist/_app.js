...
var appSelector = '#app';
var hangerSelector = '.hanger-area';
var letterControlsSelector = '.letters-container';
var wordSelector = '.word';

exports.appSelector = appSelector;
exports.hangerSelector = hangerSelector;
exports.letterControlsSelector = letterControlsSelector;
...
var _containerComponent = __webpack_require__(8);

var _containerComponent2 = _interopRequireDefault(_containerComponent);

var _hangerComponent = __webpack_require__(9);

var _hangerComponent2 = _interopRequireDefault(_hangerComponent);

var _letterControlsComponent = __webpack_require__(10);

var _letterControlsComponent2 = _interopRequireDefault(_letterControlsComponent);

var _wordComponent = __webpack_require__(15);

var _wordComponent2 = _interopRequireDefault(_wordComponent);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = [_containerComponent2.default, _hangerComponent2.default, _letterControlsComponent2.default, _wordComponent2.default];
...
(0, _uiInitializer2.default)();
(0, _eventsInitializer2.default)();
...
var _class = function _class() {
  ...
  var $el = (0, _jquery2.default)(_container2.default);
  (0, _jquery2.default)(_vars.appSelector).append($el);
};
...
var _letterControlsTpl = __webpack_require__(11);

var _letterControlsTpl2 = _interopRequireDefault(_letterControlsTpl);
...
var _class = function () {
  function _class() {
    ...
    var $el = (0, _jquery2.default)((0, _letterControlsTpl2.default)());
    (0, _jquery2.default)(_vars.letterControlsSelector).append($el);
    _lodash2.default.extend(this, { $el: $el });
  }
  ...
  _createClass(_class, [{
    ...
    value: function linker(data) {
      ...
      var last = _lodash2.default.last(used);
...
exports.default = _lodash2.default.template(_letterControls2.default);
...
exports.default = _components2.default.slice(1);
...
var _wordTpl = __webpack_require__(14);

var _wordTpl2 = _interopRequireDefault(_wordTpl);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = function (instance, word) {
  var $el = instance.$el,
      $parentEl = instance.$parentEl;

  var tpl = (0, _wordTpl2.default)({ word: word });

  if ($el) {
    $el.remove();
  }

  $el = (0, _jquery2.default)(tpl);

  $parentEl.append($el);
  _lodash2.default.extend(instance, { $el: $el });
};
...
exports.default = _lodash2.default.template(_word2.default);
...
var _lettersInitializer = __webpack_require__(13);

var _lettersInitializer2 = _interopRequireDefault(_lettersInitializer);
...
var _class = function () {
  function _class() {
    ...
    var $parentEl = (0, _jquery2.default)(_vars.wordSelector);
    _lodash2.default.extend(this, { $parentEl: $parentEl });
  }
  ...
  _createClass(_class, [{
    ...
    value: function linker(data) {
      ...
      if (!used.length) {
        return (0, _lettersInitializer2.default)(this, word);
      }

      $el.find('span').each(function (idx, el) {
        (0, _jquery2.default)(el).text(word[idx]);
      });
    }
  }]);
...
var url = 'https://guarded-cliffs-93737.herokuapp.com/';
...
var _apiConfigs = __webpack_require__(16);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = ['new', 'play'].reduce(function (o, path) {
  o[path] = function () {
    var data = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    data = _lodash2.default.extend(data, { id: _apiConfigs.id });
    return new Promise(function (resolve, reject) {
      _superagent2.default.post('' + _apiConfigs.url + path).send(data).end(function (err, res) {
        if (err) {
          return reject(err);
        }
        resolve(res.body);
...
var _linkingComponents = __webpack_require__(12);

var _linkingComponents2 = _interopRequireDefault(_linkingComponents);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = function (data) {
  _lodash2.default.each(_linkingComponents2.default, function (Constructor) {
...
exports.default = function () {
  ...
  (0, _jquery2.default)('.letter-control, .new-game').on('click', function (evt) {
    var $el = (0, _jquery2.default)(evt.target);
    var new_ = $el.hasClass('new-game');
    var method = new_ ? 'new' : 'play';
  ...
  (0, _jquery2.default)('.new-game').trigger('click');
};
...
exports.default = function () {
  _lodash2.default.each(_components2.default, function (Constructor) {
    var instance = new Constructor();
    _lodash2.default.extend(Constructor, { instance: instance });
  });
};
...
// module
exports.push([module.i, ".controls {\n  padding: 1vmin;\n  margin-top: 2vmin;\n  border: 2px dotted #ddd;\n  border-radius: 1vmin;\n  display: table-cell;\n}\n.letters-container {\n  width: 20vmin;\n}\n.letters.screen::before {\n  content: \"\";\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  z-index: 1;\n  background-color: rgba(0, 0, 0, 0);\n}\n.letters {\n  position: relative;\n  display: inline-block;\n}\n.letters > .letter-control {\n  float: left;\n  width: 5vmin;\n  height: 6vmin;\n  line-height: 6vmin;\n  text-align: center;\n  font-size: 3vmin;\n  text-transform: uppercase;\n  color: #444;\n  cursor: pointer;\n}\n.letters > .letter-control:hover {\n  border-radius: 1vmin;\n  background-color: #eee;\n}\n.letters > .letter-control.picked {\n  color: #ddd;\n  pointer-events: none;\n}\n.letters > .letter-control:nth-of-type(4n + 1) {\n  clear: left;\n}\n.label {\n  text-align: center;\n  font-size: 1.8vmin;\n  color: #777;\n  margin-bottom: 0.5vmin;\n}\nbutton {\n  display: block;\n  outline: 0;\n  width: 100%;\n  padding: 1.5vmin;\n  font: bold 2vmin/1 'Open Sans', sans-serif;\n  letter-spacing: 0.1vmin;\n  border: 1px solid #ccc;\n  border-radius: 0.5vmin;\n  text-transform: uppercase;\n  background-color: #eee;\n  cursor: pointer;\n  color: #333;\n  margin-top: 2vmin;\n}\nbutton:hover {\n  background-color: #ccc;\n  border-color: #aaa;\n  color: #111;\n}\nbutton:active {\n  background-color: #aaa;\n  color: #000;\n}\n", ""]);
...
// module
exports.push([module.i, ".word {\n  display: table;\n  margin: 2vmin auto;\n  padding: 3vmin 3vmin 2vmin;\n  border: 2px dotted #ccc;\n  border-radius: 1vmin;\n  white-space: nowrap;\n}\n.word .letter {\n  display: inline-block;\n  height: 5vmin;\n  width: 6vmin;\n  position: relative;\n}\n.word .letter span {\n  position: absolute;\n  top: -0.5vmin;\n  left: 0vmin;\n  width: 100%;\n  height: 100%;\n  font: normal 7.5vmin/1 'Coming Soon', sans-serif;\n  color: #666;\n  text-transform: uppercase;\n  text-align: center;\n}\n.word .letter span:empty::before {\n  content: \"\";\n  position: absolute;\n  width: 100%;\n  left: 0;\n  bottom: -1vmin;\n  border: 1px solid #999;\n}\n.word .letter + .letter {\n  margin-left: 3vmin;\n}\n", ""]);
